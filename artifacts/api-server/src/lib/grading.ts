...
export async function gradeAnswer(opts: {
  ...
  try {
    const out = await chatJson<{ correct: boolean; explanation: string }>(
      [
        "You grade short college ethics answers. Judge whether the student's answer is ACTUALLY CORRECT as an answer to the question, using your own expert knowledge of ethics and reasoning. Judge on substance alone.",
        "",
